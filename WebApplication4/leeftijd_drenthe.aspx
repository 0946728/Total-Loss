<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="leeftijd_drenthe.aspx.cs" Inherits="WebApplication4.leeftijd_drenthe" %>
...
<body>
 ...
 <div class="topnav" id="myTopnav">
  ...
  <a href="contact.aspx">Contact</a>
    ...
    <h1 style="color: #FF8000; font-size: 45px; margin-top: -20px; text-align: center; margin: auto;">Drenthe: Leeftijd</h1>
    <div class="grafieklayout">
      <p style="color: white; font-size: 20px; padding-left: 20px;">De Vraag: Welke leeftijdscategorie maakt in Drenthe de meeste ongelukken?</p>
