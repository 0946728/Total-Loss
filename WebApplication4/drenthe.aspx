<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="drenthe.aspx.cs" Inherits="WebApplication4.drenthe" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Provincie Drenthe ~ Total Loss</title>
...
<body>
 ...
 <div class="topnav" id="myTopnav">
  ...
  <a href="contact.aspx">Contact</a>
    ...
    <h1 style="color: #FF8000; font-size: 45px; margin-top: -20px; text-align: center; margin: auto;">Drenthe</h1>
    <div class="grafieklayout">
      <img src="drente.png" alt="logo" style=" width: 378px; height: 478px;  float: right; margin-right: 20px; margin-top: 10px;"/>
...
<div class="sidenav">
  ...
  <a  style="border-bottom: 2px solid #FF8000; height: 30px; color: #FF8000; ">Drenthe</a>
                                                                                                 <a href="geslacht_drenthe.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Geslacht</a>
                                                                                                  <a href="leeftijd_drenthe.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Leeftijd</a>
                                                                                                  <a href="merken_drenthe.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Merken</a>
                                                                                                  <a href="hoofdoorzaak_drenthe.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Hoofdoorzaak</a>
                                                                                                  <a href="nationaliteiten_drenthe.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Nationaliteiten</a>
