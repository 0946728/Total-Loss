<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="flevoland.aspx.cs" Inherits="WebApplication4.flevoland" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Provincie Flevoland ~ Total Loss</title>
...
<body>
 ...
 <div class="topnav" id="myTopnav">
  ...
  <a href="contact.aspx">Contact</a>
    ...
    <h1 style="color: #FF8000; font-size: 45px; margin-top: -20px; text-align: center; margin: auto;">Flevoland</h1>
    <div class="grafieklayout">
      <img src="flevoland.png" alt="logo" style=" width: 378px; height: 478px;  float: right; margin-right: 20px; margin-top: 10px;"/>
...
<div class="sidenav">
  ...
  <a href="drenthe.aspx" style="border-bottom: 2px solid #FF8000; height: 30px;">Drenthe</a>
   <a style="border-bottom: 2px solid #FF8000; height: 30px; color: #FF8000;">Flevoland</a>
                                                                                                  <a href="geslacht_flevoland.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Geslacht</a>
                                                                                                  <a href="leeftijd_flevoland.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Leeftijd</a>
                                                                                                  <a href="merken_flevoland.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Merken</a>
                                                                                                  <a href="hoofdoorzaak_flevoland.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Hoofdoorzaak</a>
                                                                                                  <a href="nationaliteiten_flevoland.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Nationaliteiten</a>
  </div>
