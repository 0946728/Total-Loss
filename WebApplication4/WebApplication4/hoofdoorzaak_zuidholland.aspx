<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hoofdoorzaak_zuidholland.aspx.cs" Inherits="WebApplication4.hoofdoorzaak_zuidholland" %>
...
<body>
 ...
 <div class="topnav" id="myTopnav">
  ...
  <a href="contact.aspx">Contact</a>
    ...
    <h1 style="color: #FF8000; font-size: 45px; margin-top: -20px; text-align: center; margin: auto;">Zuid Holland: Hoofdoorzaak</h1>
    <div class="grafieklayout">
      <p style="color: white; font-size: 20px; padding-left: 20px;">De Vraag: Wat is de hoofdoorzaak van de verkeersongevallen in Zuid Holland?</p>
...
<div class="sidenav">
  ...
  <div class="dropdown-container">
    <a style="border-bottom: 2px solid #FF8000; height: 30px; color: #FF8000;">Zuid Holland</a>
                                                                                                  ...
                                                                                                  <a href="hoofdoorzaak_zuidholland.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD; color: #FF8000;">Hoofdoorzaak</a>
