<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="geslacht_noordholland.aspx.cs" Inherits="WebApplication4.geslacht_noordholland" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Provincie Noord Holland ~ Total Loss</title>
...
>>>>>>> 784becd4ea6a3a369aa1a138427e341f3ae254c0
    ...
    <h1 style="color: #FF8000; font-size: 45px; margin-top: -20px; text-align: center; margin: auto;">Noord Holland: Geslacht</h1>
    <div class="grafieklayout">
      <p style="color: white; font-size: 20px; padding-left: 20px;">De Vraag: Zijn er meer mannelijke of vrouwelijke slachtoffers in Noord Holland?</p>
<<<<<<< HEAD
      <img src="noord-holland.png" alt="logo" style=" width: 378px; height: 478px;  float: right; margin-right: 20px; margin-top: 10px;"/>&nbsp;<p style="color: white; font-size: 20px; padding-left: 20px; margin-top: 10px; float:left">- Uitleg over wat er te zien is.</p>
    <br></br>
...
=======
      <img src="noord-holland.png" alt="logo" style=" width: 378px; height: 478px;  float: right; margin-right: 20px; margin-top: 10px;"/>
...
<div class="sidenav">
  ...
  <a style="border-bottom: 2px solid #FF8000; height: 30px; color: #FF8000;">Noord-Holland</a>
                                                                                                  <a href="geslacht_noordholland.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD; color: #FF8000;">Geslacht</a>
                                                                                                  <a href="leeftijd_noordholland.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Leeftijd</a>
                                                                                                  <a href="merken_noordholland.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Merken</a>
                                                                                                  <a href="hoofdoorzaak_noordholland.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Hoofdoorzaak</a>
                                                                                                  <a href="nationaliteiten_noordholland.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD; ">Nationaliteiten</a>
