...
{
    public partial class geslacht_noordholland : System.Web.UI.Page
    {
<<<<<<< HEAD
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string sqlst = "SELECT  count(_GESLACHT_) as Aantal " +
                            ...
                            " where _PVE_NAAM_ like '%Noord-Holland%' and s._VKL_NUMMER_ = o._VKL_NUMMER_ group by _GESLACHT_";
