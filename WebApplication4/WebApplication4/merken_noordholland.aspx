<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="merken_noordholland.aspx.cs" Inherits="WebApplication4.merken_noordholland" %>
...
<body>
 ...
 <div class="topnav" id="myTopnav">
  ...
  <a href="contact.aspx">Contact</a>
    ...
    <h1 style="color: #FF8000; font-size: 45px; margin-top: -20px; text-align: center; margin: auto;">Noord Holland: merken</h1>
    <div class="grafieklayout">
      <p style="color: white; font-size: 20px; padding-left: 20px;">De Vraag: Met welk automerk worden in Noord Holland de meeste ongelukken gemaakt?</p>
...
<div class="sidenav">
  ...
  <a style="border-bottom: 2px solid #FF8000; height: 30px; color: #FF8000;">Noord-Holland</a>
                                                                                                  ...
                                                                                                  <a href="merken_noordholland.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD; color: #FF8000;">Merken</a>
