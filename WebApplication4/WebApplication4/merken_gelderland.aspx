<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="merken_gelderland.aspx.cs" Inherits="WebApplication4.merken_gelderland" %>
...
<body>
 ...
 <div class="topnav" id="myTopnav">
  ...
  <a href="contact.aspx">Contact</a>
     ...
     <h1 style="color: #FF8000; font-size: 45px; margin-top: -20px; text-align: center; margin: auto;">Gelderland: Merken</h1>
    <div class="grafieklayout">
      <p style="color: white; font-size: 20px; padding-left: 20px;">De Vraag: Met welk automerk worden in Gelderland de meetse ongelukken gemaakt?</p>
...
<div class="sidenav">
  ...
  <a href="noordbrabant.aspxl" style="border-bottom: 2px solid #FF8000; height: 30px;">Noord-Brabant</a>
