<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hoofdoorzaak_noordbrabant.aspx.cs" Inherits="WebApplication4.hoofdoorzaak_noordbrabant" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Provincie Noord Brabant ~ Total Loss</title>
...
>>>>>>> 784becd4ea6a3a369aa1a138427e341f3ae254c0
 ...
 <div class="topnav" id="myTopnav">
  ...
  <a href="contact.aspx">Contact</a>
    ...
    <h1 style="color: #FF8000; font-size: 45px; margin-top: -20px; text-align: center; margin: auto;">Noord Brabant: Hoofdoorzaak</h1>
    <div class="grafieklayout">
      <p style="color: white; font-size: 20px; padding-left: 20px;">De Vraag: Wat is de hoofdoorzaak van de verkeersongevallen in Noord Brabant?</p>
      <img src="noord-brabant.png" alt="logo" style=" width: 378px; height: 478px;  float: right; margin-right: 20px; margin-top: 10px;"/>
<<<<<<< HEAD
...
<div class="sidenav">
 ...
 <a href="noordholland.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; ">Noord-Holland</a>
  ...
  <a style="border-bottom: 2px solid #FF8000; height: 30px; color: #FF8000;">Noord-Brabant</a>
                                                                                                  <a href="geslacht_noordbrabant.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Geslacht</a>
                                                                                                  <a href="leeftijd_noordbrabant.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Leeftijd</a>
                                                                                                  <a href="merken_noordbrabant.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Merken</a>
                                                                                                  <a href="hoofdoorzaak_noordbrabant.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Hoofdoorzaak</a>
                                                                                                  <a href="nationaliteiten_noordbrabant.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Nationaliteiten</a>
