<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nationaliteiten_groningen.aspx.cs" Inherits="WebApplication4.nationaliteiten_groningen" %>
...
<body>
 ...
 <div class="topnav" id="myTopnav">
  ...
  <a href="contact.aspx">Contact</a>
     ...
     <h1 style="color: #FF8000; font-size: 45px; margin-top: -20px; text-align: center; margin: auto;">Groningen: Nationaliteiten</h1>
    <div class="grafieklayout">
      <p style="color: white; font-size: 20px; padding-left: 20px;">De Vraag: Onder welke nationaliteit gebeuren er de meeste ongelukken in Groningen?</p>
...
<div class="sidenav">
  ...
  <a  style="border-bottom: 2px solid #FF8000; height: 30px; color: #FF8000;">Groningen</a>
                                                                                                  ...
                                                                                                  <a href="nationaliteiten_groningen.aspx.aspx.aspx.aspx.aspx.aspx.aspx.aspx.aspx.aspx.aspx.aspx.aspx.aspx.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Nationaliteiten</a>
