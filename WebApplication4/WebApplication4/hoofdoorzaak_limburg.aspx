<<<<<<< HEAD
﻿<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hoofdoorzaak_limburg.aspx.cs" Inherits="WebApplication4.hoofdoorzaak_limburg" %>
=======
﻿<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hoofdoorzaak_limburg.aspx.cs" Inherits="WebApplication4.hoofoorzaak_limburg" %>
...
<head runat="server">
    <title>Provincie Limburg ~ Total Loss</title>
...
>>>>>>> 784becd4ea6a3a369aa1a138427e341f3ae254c0
 ...
 <div class="topnav" id="myTopnav">
  ...
  <a href="contact.aspx">Contact</a>
    ...
    <h1 style="color: #FF8000; font-size: 45px; margin-top: -20px; text-align: center; margin: auto;">Limburg: Hoofdoorzaak</h1>
    <div class="grafieklayout">
      <p style="color: white; font-size: 20px; padding-left: 20px;">De Vraag: Wat is de hoofdoorzaak van de verkeersongevallen in Limburg?</p>
<<<<<<< HEAD
      <img src="groningen.png" alt="logo" style=" width: 378px; height: 478px;  float: right; margin-right: 20px; margin-top: 10px;"/>
    ...
    <p style="color: white; font-size: 20px; padding-left: 20px; margin-top: 10px; float: left;">- Conclusie: .....<asp:Chart ID="Chart1" runat="server">
        <Series>
...
=======
      <img src="limburg.png" alt="logo" style=" width: 378px; height: 478px;  float: right; margin-right: 20px; margin-top: 10px;"/>
...
<<<<<<< HEAD
  ...
  <a  style="border-bottom: 2px solid #FF8000; height: 30px; color: #FF8000;">Groningen</a>
                                                                                                  <a href="geslacht_limburg.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Geslacht</a>
                                                                                                  <a href="leeftijd_limburg.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Leeftijd</a>
                                                                                                  <a href="merken_limburg.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Merken</a>
                                                                                                  <a href="hoofdoorzaak_limburg.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Hoofdoorzaak</a>
                                                                                                  <a href="nationaliteiten_limburg.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Nationaliteiten</a>
=======
...
=======
  <a style="border-bottom: 2px solid #FF8000; height: 30px; color: #FF8000;">Limburg</a>
                                                                                                  <a href="geslacht_limburg.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Geslacht</a>
                                                                                                  <a href="leeftijd_limburg.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Leeftijd</a>
                                                                                                  <a href="merken_limburg.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Merken</a>
                                                                                                  <a href="hoofdoorzaak_limburg.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD;">Hoofdoorzaak</a>
