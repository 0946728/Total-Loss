<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="leeftijd_noordholland.aspx.cs" Inherits="WebApplication4.leeftijd_noordholland" %>
...
>>>>>>> 784becd4ea6a3a369aa1a138427e341f3ae254c0
 ...
 <div class="topnav" id="myTopnav">
  ...
  <a href="contact.aspx">Contact</a>
    ...
    <h1 style="color: #FF8000; font-size: 45px; margin-top: -20px; text-align: center; margin: auto;">Noord Holland: Leeftijd</h1>
    <div class="grafieklayout">
      <p style="color: white; font-size: 20px; padding-left: 20px;">De Vraag: Welke leeftijdscategorie maakt in Noord Holland de meeste ongelukken?</p>
...
<div class="sidenav">
  ...
  <a style="border-bottom: 2px solid #FF8000; height: 30px; color: #FF8000;">Noord-Holland</a>
                                                                                                  ...
                                                                                                  <a href="leeftijd_noordholland.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD; color: #FF8000;">Leeftijd</a>
