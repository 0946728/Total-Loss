<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hoofdoorzaak_noordholland.aspx.cs" Inherits="WebApplication4.hoofdoorzaak_noordholland" %>
...
<body>
 ...
 <div class="topnav" id="myTopnav">
  ...
  <a href="contact.aspx">Contact</a>
    ...
    <h1 style="color: #FF8000; font-size: 45px; margin-top: -20px; text-align: center; margin: auto;">Noord Holland: Hoofdoorzaak</h1>
    <div class="grafieklayout">
      <p style="color: white; font-size: 20px; padding-left: 20px;">De Vraag: Wat is de hoofdoorzaak van de verkeersongevallen in Noord Holland?</p>
...
<div class="sidenav">
  ...
  <a style="border-bottom: 2px solid #FF8000; height: 30px; color: #FF8000;">Noord-Holland</a>
                                                                                                  ...
                                                                                                  <a href="hoofdoorzaak_noordholland.aspx" style="border-bottom: 2px solid #FF8000; height: 30px; background: #BDBDBD; color: #FF8000;">Hoofdoorzaak</a>
