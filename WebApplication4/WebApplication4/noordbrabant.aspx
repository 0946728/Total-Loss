<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="noordbrabant.aspx.cs" Inherits="WebApplication4.noordbrabant" %>
...
<body>
 ...
 <div class="topnav" id="myTopnav">
  ...
  <a href="contact.aspx">Contact</a>
    ...
    <h1 style="color: #FF8000; font-size: 45px; margin-top: -20px; text-align: center; margin: auto;">Noord Brabant</h1>
    <div class="grafieklayout">
      ...
      <img src="grafiekstaaf.png" alt="logo" style=" width: 280px; height: 180px;  float: left; margin-left: 10px; margin-top: 10px; border: 2px solid #FF8000; "/>
      
   
     <img src="grafiekstaaf.png" alt="logo" style=" width: 280px; height: 180px;  float: left; margin-left: 10px; margin-top: 10px; border: 2px solid #FF8000; "/>
      <img src="grafiektaart.png" alt="logo" style=" width: 280px; height: 180px;  float: left; margin-left: 10px; margin-top: 10px; border: 2px solid #FF8000; "/>
        <img src="grafiektaart.png" alt="logo" style=" width: 280px; height: 180px;  float: left; margin-left: 10px; margin-top: 10px; border: 2px solid #FF8000; "/>
         <img src="grafiektaart.png" alt="logo" style=" width: 280px; height: 180px;  float: left; margin-left: 10px; margin-top: 10px; border: 2px solid #FF8000; "/>
