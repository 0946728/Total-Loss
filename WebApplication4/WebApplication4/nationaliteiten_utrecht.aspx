<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nationaliteiten_utrecht.aspx.cs" Inherits="WebApplication4.nationaliteiten_utrecht" %>
...
<body>
  ...
  <a href="contact.aspx">Contact</a>
    ...
    <h1 style="color: #FF8000; font-size: 45px; margin-top: -20px; text-align: center; margin: auto;">Utrecht: Nationaliteiten</h1>
    <div class="grafieklayout">
      <p style="color: white; font-size: 20px; padding-left: 20px;">De Vraag: Onder welke nationaliteit gebeuren er de meeste ongelukken in Utrecht?</p>
