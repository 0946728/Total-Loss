<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="leeftijd_utrecht.aspx.cs" Inherits="WebApplication4.leeftijd_utrecht" %>
...
<body>
 ...
 <div class="topnav" id="myTopnav">
  ...
  <a href="contact.aspx">Contact</a>
   ...
   <h1 style="color: #FF8000; font-size: 45px; margin-top: -20px; text-align: center; margin: auto;">Utrecht: Leeftijd</h1>
    <div class="grafieklayout">
      <p style="color: white; font-size: 20px; padding-left: 20px;">De Vraag: Welke leeftijdscategorie maakt in Utrecht de meeste ongelukken?</p>
