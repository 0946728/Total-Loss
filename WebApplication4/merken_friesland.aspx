<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="merken_friesland.aspx.cs" Inherits="WebApplication4.merken_friesland" %>
...
<body>
 ...
 <div class="topnav" id="myTopnav">
  ...
  <a href="contact.aspx">Contact</a>
    ...
    <h1 style="color: #FF8000; font-size: 45px; margin-top: -20px; text-align: center; margin: auto;">Friesland: Merken</h1>
    <div class="grafieklayout">
      <p style="color: white; font-size: 20px; padding-left: 20px;">De Vraag: Met welk automerk worden in Friesland de meeste ongelukken gemaakt?</p>
